...
@section('content')
  ...
  <li class="nav-item active">
    <a style="color:#d4a60b;" class="nav-link" href="{{ route('/home') }}">Home</a>
  </li>
  <li class="nav-item">
...
<div class="col-md-8 offset-md-2 my-5">
  <h4 class="text-center" style="color: #0b9cd4;">All Cost Account<a class="btn btn-success pull-right" href="{{action('AdminController@addMemberPage')}}">+ Add Member</a></h4>
  <div id="message">
    @if(session('message'))
